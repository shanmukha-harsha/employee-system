package com.toro.employee.services;

import com.toro.employee.entity.EmployeeEntity;
import com.toro.employee.model.Employee;
import com.toro.employee.repository.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee updateEmployee(Long id, Employee employee) {
        System.out.println("Inside update Employee in Service Impl");
        EmployeeEntity employeeEntity = employeeRepository.findById(id).get();
